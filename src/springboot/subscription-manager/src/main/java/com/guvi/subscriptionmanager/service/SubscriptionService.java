...
import com.guvi.subscriptionmanager.config.SecurityUtil;
...
public class SubscriptionService {
    ...
    public Subscription subscribe(String planCode, boolean autoRenew) {
    ...
    public List<Subscription> listByUser() {
        Long userId = SecurityUtil.getCurrentUserId();
